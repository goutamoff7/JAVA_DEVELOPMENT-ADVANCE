package com.example.springBootAOPDemo.service;

import com.example.springBootAOPDemo.model.JobPost;
import com.example.springBootAOPDemo.repository.JobRepository;
...
public class JobService {
    ...
    public List<JobPost> getAllJobs() {
        int a = 10/0; // intentionally create to check @AfterThrowing
